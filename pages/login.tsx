      ...
      <div className="pt-28 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-full h-screen">
        <form className=" h-auto w-96 bg-black bg-opacity-10 rounded-xl ">
          ...
          <div className="mt-6">
            ...
            <input placeholder="Tên đăng nhập" className="w-3/4  border-b-2 bg-black bg-opacity-0 border-white" ></input>
          </div>
          <div className="mt-6">
            <FontAwesomeIcon icon={faLock} style={{color: "#ffffff",}}  className="pr-3"/>
            <input placeholder="Mật khẩu" className="w-3/4  border-b-2 bg-black bg-opacity-0 border-white" ></input>
          ...
          <div className="mt-7 text-xs text-white">
              ...
              <Link href="" className="float-right pr-8">Đăng ký</Link>
          </div>

          <button className="mt-10 uppercase text-white bg-red-400 rounded-md h-9 w-3/4">đăng nhập</button>
