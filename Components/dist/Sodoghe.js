...
var Sodoghe = function (_a) {
    ...
    var _7 = react_1.useState([]), arrIdDV = _7[0], setArrIdDV = _7[1];
    // const [arrIdghe, setArrIdghe] = useState<number[]>([]);
    var _8 = react_1.useState(false), showModalDA = _8[0], setShowModalDA = _8[1];
    var _9 = react_1.useState(false), showModalKM = _9[0], setShowModalKM = _9[1];
    var _10 = react_1.useState(Number), r = _10[0], setR = _10[1];
    var _11 = react_1.useState([]), dsdoans = _11[0], setDsdoans = _11[1];
    var _12 = react_1["default"].useState(0), checked = _12[0], setChecked = _12[1];
    var temp;
    ...
    ]), dsgheDDs = _13[0], setDsgheDDs = _13[1];
    ...
    ]), DSchitietves = _14[0], setDSchitietves = _14[1];
