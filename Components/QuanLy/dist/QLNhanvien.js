            ...
            react_1["default"].createElement("tbody", null, nhanvien.map(function (item, index) { return (react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement("tr", { key: item.id },
                    ...
                    react_1["default"].createElement("td", { className: "border border-slate-300 text-center" },
                        ...
                        " "),
                    react_1["default"].createElement("td", { className: "border border-slate-300 text-center" },
                        react_1["default"].createElement(Edit_1["default"], { className: "cursor-pointer", onClick: function () { return handleSuaTTNhanvien(item.id, item.Hten_NV, item.Sdt_NV, item.Ngaysinh_NV, item.Tuoi_NV, item.Diachi_NV, item.Gioitinh_NV, item.Cccd_NV, item.Chucvu_NV, item.Taikhoan_NV, item.Matkhau_NV); } }),
