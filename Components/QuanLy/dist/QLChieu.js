    ...
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement("div", { className: "space-y-5" },
            ...
            react_1["default"].createElement("div", { className: "flex space-x-5" },
                react_1["default"].createElement("p", { className: "basis-[20%]" }, "Ng\u00E0y chi\u1EBFu"),
            ...
            react_1["default"].createElement("div", { className: " w-8/12 " },
                react_1["default"].createElement("button", { onClick: function () { return handleThemTTChieu(); }, className: "boder border-2 mb-10 bg-blue-400 font-bold float-right h-10 w-40" }, "Th\u00EAm CSVC"),
                react_1["default"].createElement("button", { onClick: function () { return handleCapnhatTTChieu(); }, className: "boder border-2 mb-10 bg-blue-400 font-bold float-right h-10 w-40" }, "C\u1EADp nh\u1EADt n\u1ED9i quy"))),
